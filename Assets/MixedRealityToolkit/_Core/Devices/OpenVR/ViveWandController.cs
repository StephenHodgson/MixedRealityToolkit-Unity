...
namespace Microsoft.MixedReality.Toolkit.Internal.Devices.OpenVR
{
    public class ViveWandController : GenericOpenVRController
    {
        ...
        public new static readonly MixedRealityInteractionMapping[] DefaultLeftHandedInteractions =
        {
            ...
            new MixedRealityInteractionMapping(4, "Grip Press", AxisType.SingleAxis, DeviceInputType.Trigger, MixedRealityInputAction.None, ControllerMappingLibrary.MIXEDREALITY_AXIS11),
        ...
        public new static readonly MixedRealityInteractionMapping[] DefaultRightHandedInteractions =
        {
            ...
            new MixedRealityInteractionMapping(4, "Grip Press", AxisType.SingleAxis, DeviceInputType.Trigger, MixedRealityInputAction.None, ControllerMappingLibrary.MIXEDREALITY_AXIS12),
