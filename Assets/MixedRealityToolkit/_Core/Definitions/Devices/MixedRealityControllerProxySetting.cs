...
namespace Microsoft.MixedReality.Toolkit.Core.Definitions.Devices
{
    ...
    public struct MixedRealityControllerProxySetting
    {
        ...
        public MixedRealityControllerProxySetting(string description, Type controllerType, Handedness handedness = Handedness.None, GameObject overrideModel = null) : this()
        {
